...
MERITS = [
    ...
    ("無料修理付き", "もしものときにも安心の、無料修理付プランもございます。"),
    ("最新機種は省エネ", "省エネ・節電の最新機種で、電気代が大幅に下がります。"),
...
FLOW = [
    ...
    ("リース審査申込み", "必要書類のご案内から提出まで、当社とリース会社でサポートします。"),
    ("リース契約", "内容をご確認のうえ、ご契約いただきます。"),
    ("エアコン設置工事", "当社の工事部が施工します。工事完了後もお付き合いは続きます。"),
]
...
""" + phero("Air Conditioner", "業務用エアコン",
            "オフィスや工場、飲食店の業務用エアコンならリースがおすすめです。入替が面倒な空調設備が、初期費用0円でご利用いただけます。お気軽にご相談ください。",
